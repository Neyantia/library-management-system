...
export class BorrowedBookResponseDto {
  @ApiProperty({ example: 'ceae8333-47a6-462b-9920-2f0051example' })
  id: string;

  @ApiProperty({ enum: BorrowingStatus, example: BorrowingStatus.ACTIVE })
  ...
  @ApiProperty({ enum: BookStatus, example: BookStatus.BORROWED })
